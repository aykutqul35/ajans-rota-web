...
export default async function handler(req, res) {
  ...
  // Kullanıcının oturum açtığını doğrula (Header'dan token al)
  ...
  try {
    ...
    // Eğer sadece yeni şifre girildiyse (kullanıcı adı aynıysa)
    ...
    // Unique constraint hatası (Aynı isimde başka kullanıcı varsa)
    if (error.code === '23505') {
