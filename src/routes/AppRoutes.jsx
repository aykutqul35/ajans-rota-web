...
export default function AppRoutes(props) {
  ...
  return (
    <Routes>
            ...
            <Route path="/akademi" element={<AkademiPageView onBack={() => navigate('/')} onSaveLead={simulateLeadLocally} logHit={logHit} academyCoursesData={academyCoursesData} />} />
            ...
            <Route path="/" element={
              <HomePage
                ...
                isOnlySeoSelected={isOnlySeoSelected}
